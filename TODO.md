...
- **A. Technical Indicators Suite**
  ...
  - [x] UI: Implement Bollinger Bands (BB) visualization on chart.  - [ ] Backend: Implement Relative Strength Index (RSI) calculation logic (customizable period, overbought/oversold levels).
